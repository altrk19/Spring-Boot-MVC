...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        //log.warn("#######");
        //log.warn("Count uom : " + unitOfMeasureReactiveRepository.count().block().toString());
        //log.warn("Count category: " + categoryReactiveRepository.count().block().toString());
        //log.warn("Count recipe: " + recipeReactiveRepository.count().block().toString());
    }
